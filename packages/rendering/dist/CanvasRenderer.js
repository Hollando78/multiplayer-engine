...
class CanvasRenderer {
    ...
    setupResizing() {
        ...
        this.canvas._resizeObserver = resizeObserver;
    }
    /**
     ...
     */
    drawGrid(viewport) {
        if (!this.config.showGrid || viewport.zoom < this.config.gridFadeZoom)
            return;
     ...
     */
    drawCell(cell, viewport, animation) {
    ...
    destroy() {
        ...
        const resizeObserver = this.canvas._resizeObserver;
        if (resizeObserver) {
            resizeObserver.disconnect();
            delete this.canvas._resizeObserver;
        }
