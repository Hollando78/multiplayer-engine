...
exports.PrismaAuthStorage = void 0;
const auth_1 = require("@multiplayer-engine/auth");
class PrismaAuthStorage extends auth_1.AuthStorage {
    prisma;
    constructor(prisma) {
        super();
        this.prisma = prisma;
     ...
     */
    async storeRefreshToken(token, userId, expiresAt) {
     ...
     */
    async getUserByIdWithHash(userId) {
        const user = await this.prisma.user.findUnique({
            where: { id: userId },
            select: {
                id: true,
...
exports.PrismaAuthStorage = PrismaAuthStorage;
//# sourceMappingURL=PrismaAuthStorage.js.map